 ...
 * @date 2011/9/16
 * @param {DocumentElement|String} target form or form's id
 */
baidu.form = baidu.form || {};
baidu.form.Ajaxform = baidu.lang.createClass(function(target){
	 ...
	 * @param {boolean} successfull 是否要获取没有name，diabled，reset，button等的值，默认true
